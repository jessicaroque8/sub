...
User.create!(staff_id_mb: 100000285, first_name: 'Ken', last_name: 'Berry')
User.create!(staff_id_mb: 100000164, first_name: 'Jennifer', last_name: 'Anderson')
User.create!(staff_id_mb: 100000270, first_name: 'Johnny', last_name: 'Salke')
users = User.all
