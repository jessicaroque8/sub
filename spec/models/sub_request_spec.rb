...
RSpec.describe SubRequest, type: :model do
  ...
  describe "attributes" do
     it "has datetime, class_name, class_id_mb, note" do
        expect(my_sub_request).to have_attributes(user_id: my_user.id, group_id: my_group.id, datetime: datetime, class_name: 'Vinyasa Yoga', class_id_mb: 1000, note: 'Please cover me')
     end
  end
